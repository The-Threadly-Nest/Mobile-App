...
export default function AdminWelcomeScreen() {
  return (
    <View style={styles.container}>
      {/* Top Image — Full width, no horizontal padding */}
      ...
      <SafeAreaView edges={["bottom"]} style={styles.content}>
        ...
        <View style={styles.textSection}>
          <Text style={styles.title}>Welcome, Fashion House Owner</Text>
          <Text style={styles.subtitle}>
            Create your account to start managing bookings, staff, and orders.
          </Text>
        </View>
